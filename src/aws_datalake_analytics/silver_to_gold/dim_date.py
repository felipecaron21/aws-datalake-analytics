...
silver_key_reviews = "silver/order_reviews/order_reviews.parquet"
gold_key = "gold/date/dim_date.parquet"


cliente_s3 = criar_cliente_s3()

df_orders = ler_parquet_do_s3(cliente_s3, bucket_name, silver_key_orders)
df_order_reviews = ler_parquet_do_s3(cliente_s3, bucket_name, silver_key_reviews)
